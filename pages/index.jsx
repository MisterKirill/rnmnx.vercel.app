	...
	return (
		<>
			...
			<div className="flex justify-center">
				<div className="flex flex-col c1:flex-row gap-16 mt-[180px] items-center">
					<div className="flex">
			...
			<div className="flex justify-center mt-5">
				<div className="p-5 bg-[#41110f] c2:rounded-xl w-screen c2:w-auto flex flex-col gap-3 items-center">
					...
					<iframe width="560" className="w-[300px] c3:w-[500px] c3:h-[255px]" src="https://www.youtube.com/embed/HxY4pUVVExY" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen />
				</div>
			</div>
