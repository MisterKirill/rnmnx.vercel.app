        ...
        <>
            ...
            <header className="container px-[50px] c1:px-[250px] min-w-[100vw] absolute flex flex-col c3:flex-row gap-3 justify-between py-5 items-center">
                ...
                <div className="flex gap-5 items-center">
                    ...
                    <div className="flex flex-col items-center group">
                        <a href="https://www.youtube.com/channel/UCLtk7D27n95sQyNGN8mVBHQ" target="_blank" className="hover:mt-1"><i onMouseOver={() => changeTheme('#c3352e')} onMouseOut={() => changeTheme()} className="bi bi-music-note text-white text-[40px]" /></a>
                        <span className="text-white absolute mt-[55px] opacity-0 transition-opacity duration-300 group-hover:opacity-100 pointer-events-none">YouTube Music</span>
                    </div>
                    <div className="flex flex-col items-center group">
